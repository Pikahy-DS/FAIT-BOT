...
def initConfig():
	...
	setCell( "vk_album_id", 1 ) # ID альбома, куда будут заливаться стикеры из тележки
	...
	setCell( "vk_135268150", '1005179687' ) # Пример переадресации ЛС ВК в Telegram
	setCell( "t_1005179687", '135268150' ) # Пример переадресации ЛС ВК в Telegram
